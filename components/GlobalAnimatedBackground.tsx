  ...
  return (
    <>
      ...
      >
        ...
        <div className="relative w-[800px] h-[800px] opacity-30 md:opacity-40">
          ...
          <motion.div 
            ...
            className="absolute inset-[40px] border-[1px] border-purple-500/30 rounded-[60%_40%_30%_70%_/_60%_30%_70%_40%] will-change-transform"
          />
          ...
          <motion.div 
            ...
            className="absolute inset-[100px] border border-dashed border-white/20 rounded-full will-change-transform"
          />
          ...
          <motion.div 
            ...
            className="absolute inset-[150px] border-[2px] border-cyan-400/40 rounded-full will-change-transform"
          ...
          <motion.div 
            ...
            className="absolute inset-[200px] bg-gradient-to-br from-cyan-500/20 to-purple-600/20 rounded-full blur-2xl will-change-transform"
          ></motion.div>
        </div>
